...
def main():
    ...
    for i in range(2, sheet.max_row + 1):
        ...
        contract_amount = round(sheet[f'L{i}'].value, 2)  # 合同金额 <contract_amount>
        settlement_amount = round(sheet[f'M{i}'].value, 2)  # 结算金额 <settlement_amount>
        ...
        replace_variables(
            ...
            settlement_sign_date=settlement_sign_date  # 结算协议签订年月 <settlement_sign_date>
        )
        # 保存文件
